...
const ClassDetailBox = styled.div`
  width: 100%;
...
const ClassCatLoc = styled.div`
  margin-top: 10px;
  display: flex;
  justify-content: space-between;
`

const ClassCat = styled.div`
  font-size: 14px;

`

const ClassLoc = styled.div`
  font-size: 14px;
  opacity: 0.8;
  margin-top: 10px;
  text-align: right;
